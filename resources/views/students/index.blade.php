            ...
            <tr class="border-b border-[#EFEDE6] hover:bg-[#FAF9F5]">
                ...
                <td class="px-5 py-4">
                    <div class="flex justify-end gap-4 text-xs font-medium">
                        <a href="{{ route('students.show', $student['id' => 1]) }}" class="text-[#16213A] hover:text-[#A16207]">Lihat</a>
                        <a href="{{ route('students.edit', $student['id' => 1]) }}" class="text-[#16213A] hover:text-[#A16207]">Ubah</a>
