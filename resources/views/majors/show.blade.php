...
<div class="mt-3 border border-[#E5E3DB] bg-white">
    <div class="flex items-start justify-between border-b border-[#E5E3DB] bg-[#FCFBF8] px-8 py-6">
        <div>
            ...
            <h1 class="font-display text-3xl font-semibold text-[#16213A]">Akutansi dan Keuangan Lembaga</h1>
    ...
    <dl class="divide-y divide-[#EFEDE6] text-sm">
        ...
        <div class="flex justify-between px-8 py-4">
            ...
            <dd class="font-medium text-[#16213A]">Program keahlian yang membekali murid dengan kompetensi akuntansi dan keuangan di lembaga.</dd>
        </div>
    </dl>
